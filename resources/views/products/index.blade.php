                ...
                <div class="panel-body">
                    <div class="row products-list">
                        @foreach($products as $product)
                            <div class="col-xs-2 product-item" style="min-width: 150px">
                                <a style="text-decoration: none;" target="_Blank" href="{{route('products.details',['product'=>$product->id])}}">
                                <div class="product-content" >
                                    <div class="top">
                                        <div class="img" style="height: 163px;"><img src="{{ $product->image_url }}" alt="" style="height: auto; min-width: 93px;"></div>
